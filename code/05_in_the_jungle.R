...
runoff_winter_key <- runoff_winter_key[,c(1,2,3,5)]
...
to_plot[year < year_thres, period := factor('1984-1999')]
to_plot[year >= year_thres, period := factor('2000-2016')]

to_plot <- to_plot[year >= 1984]
